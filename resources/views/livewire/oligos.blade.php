<div>
    ...
    <h1 class="h2 my-3">Que vaut votre complément minéral ?</h1>

    <div class="flex flex-col gap-2 lg:gap-4 lg:flex-row justify-around">

        <div id="espece" class="lg:basis-1/2 my-3">
            <h3 class="h3 pl-2 py-1 lg:pl-0 lg:text-center bg-gray-600 text-gray-200">Choisir le type de production</h3>
        ...
        <div id="stade" class="lg:basis-1/2">
            <div id="stade_chevre">
                <h3 class="h3 pl-2 py-1 lg:pl-0 lg:text-center bg-gray-600 text-gray-200">Choisir le stade physiologique</h3>
    ...
    <div>
        ...
        <div id="quantite">
            ...
            <input
                ...
                wire:change.debounce = "majQtt">g/jour par animal
        </div>
    </div>

    <div id="mineral" class="my-3">

        <h2 class="h2">Besoins et composition du minéral (mg)</h2>
        <table class="w-full table-auto border-collapse border">
            <thead class="bg-gray-700 text-gray-100 p-2">
                <tr>
                    <td class="py-3 px-4 border-gray-200 border">
                        Eléments (besoins<span class="hidden lg:inline"> en ppm</span>)
                    </td>
