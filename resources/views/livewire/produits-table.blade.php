<div x-data="{create: @entangle('create').live}">
    ...
    <div class="flex flex-row gap-5 justify-between items-center">
        ...
        <div class="flex flex-row my-2 grow sm:my-0">
            ...
            <input class="border-r-0 sm:grow" type="text" placeholder="Rechercher un produit" wire:model.live.debounce.500ms="search">

            <img class="px-2 w-10 border border-gray-500 cursor-pointer border-left-0" wire:click="resetSearch" src="{{ url('storage/img/fonticone/reset.svg')}}" alt="reset">
    ...
    <x-bloc-grille>
        ...
        @foreach ($produits as $produit)
            <li class="flex flex-col p-3 bg-gray-200 border-b-2 hover:bg-gray-300">
                <div class="flex flex-row justify-between">
                    <div class="flex flex-row items-center">
                        <img class="mr-1 w-10" src="{{ url('storage/img/produits/' . $produit->phytotype->icone) }}"
                            alt="{{ $produit->icone }}">
                        <p class="text-lg">
